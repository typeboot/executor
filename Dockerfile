...
COPY --chown=user:app core/build/libs/core*uber.jar /opt/app/lib/core-uber.jar
COPY --chown=user:app jdbc/build/libs/jdbc*uber.jar /opt/app/lib/jdbc-uber.jar
